...
def upgrade() -> None:
    ...
    op.create_foreign_key(None, 'repo_archive_category', 'repo_archive_no_rule', ['archive_no_rule_id'], ['id'], ondelete='SET NULL')
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_constraint(None, 'repo_archive_category', type_='foreignkey')
    op.alter_column('repo_archive_category', 'field_schema',
