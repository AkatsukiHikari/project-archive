...
class ErrorCode:
    ...
    # ── 档案管理 (3000-3099) ──
    # 3050-3069 档案保管（库房 / 出入库）
    VAULT_NOT_FOUND = 3050
    VAULT_CODE_EXISTS = 3051
    INOUT_RECORD_NOT_FOUND = 3052
    INOUT_STATE_CONFLICT = 3053
    ...
    # ── 档案编研 (8100-8199) ──
    RESEARCH_PROJECT_NOT_FOUND = 8100  # 编研项目不存在
    RESEARCH_RESULT_NOT_FOUND = 8101  # 编研成果不存在
    RESEARCH_STATE_CONFLICT = 8102  # 成果状态流转冲突
    RESEARCH_TEMPLATE_NOT_FOUND = 8103  # 编研模板不存在
