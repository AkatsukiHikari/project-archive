...
MENU_TREE = [
    ...
    },
    {
        ...
        "children": [
            ...
            {"code": "ai:knowledge", "name": "AI 知识库",   "type": "MENU", "path": "/ai/knowledge", "icon": "heroicons:book-open",                "sort_order": 2},
            {"code": "ai:ocr",       "name": "OCR 任务",    "type": "MENU", "path": "/ai/ocr",       "icon": "heroicons:document-magnifying-glass", "sort_order": 3},
        ],
    },
]
