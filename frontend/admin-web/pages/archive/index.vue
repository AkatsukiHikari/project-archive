...
const shortcuts = [
  ...
  { title: "利用申请", desc: "处理档案利用申请",   icon: "heroicons:document-plus",            color: "#8b5cf6", path: "/service/apply" },
  { title: "查阅登记", desc: "记录来馆查阅信息",   icon: "heroicons:eye",                      color: "#06b6d4", path: "/service/reading" },
